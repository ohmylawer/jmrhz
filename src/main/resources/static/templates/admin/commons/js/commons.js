...
function initselect_DOC(id,arry){
	...
	$.each(arry,function(i){
		if(($.trim(arry[i].dictionaryValue)).indexOf("请选择")==-1){
...
function createSelecttree(obj){
	var create = function(){
		...
		$("#"+obj.target).parent().append(
			'<div class="'+obj.target+'tree1" style="max-height:300px;overflow-y:auto;overflow-x: auto;display:none;background:#ffffff;border:1px solid #cccccc;'+width+';padding:10px;position:relative;z-index: 100;">'+
